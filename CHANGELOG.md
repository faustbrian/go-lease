...
- Resolve owned v1.0.0 dependencies through their canonical public module
  checksums instead of bootstrap-shadowed archives.
...
- Link the module to the immutable v1.4.0 Golib ecosystem index and family
  guidance.
