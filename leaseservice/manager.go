// Package leaseservice integrates managed leases with go-service lifecycle hooks.
...
// Hooks adapts the manager to go-service's caller-owned lifecycle contract.
